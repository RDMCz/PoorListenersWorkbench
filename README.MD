...
```ps1
# YouTube keeps changing its workings; first thing to try when YTPLDL fails is to update yt-dlp package
.venv\Scripts\activate  # Run this line only if you run PLW in venv 
